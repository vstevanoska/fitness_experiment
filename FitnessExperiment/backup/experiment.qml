...
Rectangle {
    ...
    property string exerciseCombo: ""
    property int sampleRate: 50
    ...
    ColumnLayout {
            ...
            onTriggered: {
                ...
                if (startCountdown && currentAccReading != null) {
                    ...
                    if (experimentData.getAccReadingsSize() < sampleRate * 30) {
                        experimentData.addAccReading(currentAccReading.timestamp, currentAccReading.x, currentAccReading.y, currentAccReading.z);

                        if (currentGyrReading != null)
                            experimentData.addGyrReading(currentGyrReading.timestamp, currentGyrReading.x, currentGyrReading.y, currentGyrReading.z);
                    }

                    if (experimentData.getAccReadingsSize() % sampleRate == 0)
                        timerValue--;
        ...
        MessageDialog
        {
            ...
            onNo: {
                ...
                experimentData.cancelExperiment();
                stack.pop();
            }
        }
